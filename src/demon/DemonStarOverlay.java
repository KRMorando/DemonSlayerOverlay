...
public class DemonStarOverlay extends JFrame {
	...
	DemonStarOverlay() {
		...
		panel.setBackground(SystemManager.backColor); // 메인 패널 색
		panel.setBorder(new LineBorder(Color.red, 2, true));
		
		label1.setText("최신 버전을 확인하는 중 입니다...");
		label1.setFont(new Font(SystemManager.ttf, Font.PLAIN, 20));
		...
		label2.setFont(new Font(SystemManager.ttf, Font.PLAIN, 20));
		...
		btn.setFont(new Font(SystemManager.ttf, Font.ITALIC, 20));
