...
public class BackButton extends JButton {
	...
	public BackButton(JFrame frame, String window) {
		/*	뒤로가기 상세 설정	*/
		setText("뒤로가기"); 												// 글씨 적용
		setFont(new Font(SystemManager.ttf, Font.PLAIN, 18)); 					// 폰트 적용
		...
		setBounds((SystemManager.window_width - width)/2, SystemManager.window_height - height - 25, width, height);
		...
		addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(SystemManager.sideContainer != null) {
					SystemManager.sideContainer.dispose();
